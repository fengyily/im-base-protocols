...
type Register struct {
	...
	RoomNo     string   `protobuf:"bytes,2,opt,name=RoomNo,proto3" json:"RoomNo,omitempty"`
	UserName   string   `protobuf:"bytes,3,opt,name=UserName,proto3" json:"UserName,omitempty"`
	HeadImgUrl string   `protobuf:"bytes,4,opt,name=HeadImgUrl,proto3" json:"HeadImgUrl,omitempty"`
	OtherInfos []string `protobuf:"bytes,5,rep,name=OtherInfos,proto3" json:"OtherInfos,omitempty"`
}
...
func (x *Register) GetRoomNo() string {
	if x != nil {
		return x.RoomNo
	}
	return ""
...
func (x *Register) GetHeadImgUrl() string {
	if x != nil {
		return x.HeadImgUrl
	}
	return ""
...
func (x *Register) GetOtherInfos() []string {
	if x != nil {
		return x.OtherInfos
	}
	return nil
...
type Registers struct {
	...
	Register []*Register `protobuf:"bytes,1,rep,name=register,proto3" json:"register,omitempty"`
}
...
func (x *Registers) GetRegister() []*Register {
	if x != nil {
		return x.Register
	}
	return nil
...
var file_register_proto_rawDesc = []byte{
	...
	0x22, 0x9a, 0x01, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x12, 0x1a, 0x0a,
	0x08, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x08, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x52, 0x6f, 0x6f,
	0x6d, 0x4e, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x52, 0x6f, 0x6f, 0x6d, 0x4e,
	...
	,
}
...
var file_register_proto_goTypes = []interface{}{
	...
	(*Registers)(nil), // 1: Registers
}
var file_register_proto_depIdxs = []int32{
	0, // 0: Registers.register:type_name -> Register
